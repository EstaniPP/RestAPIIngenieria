...
CREATE TABLE IF NOT EXISTS `mydb`.`Email_Reports` (
  ...
  `to_who` INT NULL DEFAULT NULL,
  `criteria` INT NULL DEFAULT NULL,
  `how_offen` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Workout_Reports` (
  ...
  `execution_date` DATE NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
