...
-- -----------------------------------------------------
-- Table `mydb`.`Medical_Languages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Medical_Languages` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  CONSTRAINT `fk_Medical_Languages_Languages`
    FOREIGN KEY (`language_id`)
    REFERENCES `mydb`.`Languages` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Medical_Languages_Medical_Personnel`
